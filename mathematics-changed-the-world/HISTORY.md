...
### 2026-09-26｜最优化课程进入“可学习单元”阶段

在资源索引完成后，建立 `docs/courses/optimization-pku-wenzw-study-roadmap.md`，把教材与 27 个讲义主题重组为 10 个学习单元：基础、建模、最优性、无约束、约束、复合、随机/非光滑、流形、应用、形式化。
